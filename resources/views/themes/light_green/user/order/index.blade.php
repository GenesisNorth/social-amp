...
@section('title', trans('All Orders'))
@section('content')
    <div class="dashboard-wrapper">
        <div class="container">
            <div class="breadcrumb-area">
                <h4 class="title">@lang("All Order")</h4>
                <ul class="breadcrumb">
            ...
            <div class="card mt-10">
                <div class="card-header d-flex justify-content-between align-items-center border-0">
                    <h4 class="mb-0">@lang("All Order")</h4>
                    <div class="btn-area">
                ...
                <div class="card-body">
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        ...
                                                        @if(optional($order->service)->service_status == 1)
                                                            <li><a class="dropdown-item orderBtn"
                                                                   href="javascript:void(0)"
                                                        ...
                                                        @endif
                                                        @if($order->reason)
                                                            <li><a class="dropdown-item infoBtn"
                                                                   href="javascript:void(0)"
                    ...
                    @else
                        <div class="text-center p-4">
                            ...
                            <p class="mb-0">@lang("No orders available to display.")</p>
                        </div>
                    @endif
