...
@section('title',trans('Drip Feed Orders'))
@section('content')
    <div class="dashboard-wrapper">
        <div class="container">
            <div class="breadcrumb-area">
                <h4 class="title">@lang("Drip Feed Order")</h4>
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">@lang("Drip Feed Order")</li>
                </ul>
            </div>
            ...
            <div class="card mt-10">
                <div class="card-header d-flex justify-content-between align-items-center border-0">
                    <h4 class="mb-0">@lang("All Orders")</h4>
                    <div class="btn-area">
                ...
                <div class="card-body">
                    ...
                    @else
                        <div class="text-center p-4">
                            ...
                            <p class="mb-0">@lang("No drip feed orders available to display.")</p>
                        </div>
                    @endif
                </div>
            </div>
