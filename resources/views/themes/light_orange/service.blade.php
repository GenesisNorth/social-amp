...
@section('content')
    ...
    <section class="service_page_area" id="services">
        <div class="container">
            <div class="row">
                <div class="col">
    ...
    <div class="service_page_modal">
        <!-- Modal -->
        <div class="modal fade description-modal-service" id="describeModal" tabindex="-1" aria-labelledby="describeModalLabel" aria-hidden="true"
