...
@section('title',trans('Drip Feed Order'))
@section('content')
    <main id="main" class="main bg-color2">
        <div class="pagetitle">
            <h3 class="mb-1">@lang("Drip Feed Order")</h3>
            <nav>
                <ol class="breadcrumb">
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center border-0">
                <h4 class="mb-0">@lang("Drip Feed Order")</h4>
                <div class="btn-area">
            ...
            <div class="card-body">
                ...
                @else
                    <div class="text-center p-4">
                        ...
                        <p class="mb-0">@lang("The drip feed orders is not available.")</p>
                    </div>
                @endif
            </div>
        </div>
