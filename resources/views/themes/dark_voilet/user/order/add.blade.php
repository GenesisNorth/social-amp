...
@section('content')
    <main id="main" class="main bg-color2 new_order">
        <div class="pagetitle">
            <h3 class="mb-1">@lang("new order")</h3>
            <nav>
                <ol class="breadcrumb">
                        ...
                        <form @submit.prevent="placeOrder">
                            <div class="row g-3">
                                <div class="col-12" v-cloak>
                                    ...
                                    <select class="cmn-select2" name="categories" v-model="selectedCategory"
                                ...
                                <div class="col-12" v-cloak>
                                    ...
                                    <select class="cmn-select3" name="service" v-model="selectedService"
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <div class="row g-3">
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        <label for="AvgTime"
                                               class="form-label">@lang("Avg Time")</label>
                                        <input type="text" class="form-control" v-model="avgTime"
                                               id="Avg Time" disabled>
                                    </div>
                            ...
                            <div class="col-12 mb-2">
                                ...
                                <textarea class="form-control" id="Description" rows="12"
    ...
    <script>
        ...
        const newOrder = createApp({
            ...
            computed: {
                ...
                totalPrice() {
                    const baseQuantity = this.dripFeedCheck === 'd-block'
                        ? this.quantity * this.runs
                        : this.quantity;

                    const price = (baseQuantity / 1000) * this.pricePer;
                    return price.toFixed(this.fractionNumber);
                }
            },
            ...
            methods: {
                ...
                handleServiceChange() {
                    ...
                    if (this.currency) {
                        let formattedCurrency = parseFloat(selectedService.user_rate || selectedService.price) * parseFloat(this.currency.conversion_rate);
                        this.pricePer = formattedCurrency.toFixed(2);
                    } else {
                        let formattedCurrency = parseFloat(selectedService.user_rate || selectedService.price);
                        this.pricePer = formattedCurrency.toFixed(2);
                    }
                    ...
                    this.avgTime = this.formatAverageTime(selectedService.average_time_minutes);
                ...
                handleCategoryChange() {
                    ...
                    if (this.services.length > 0) {
                        ...
                        if (this.currency) {
                            let formattedCurrency = parseFloat(this.services[0].user_rate || this.services[0].price) * parseFloat(this.currency.conversion_rate);
                            this.pricePer = formattedCurrency;
                        } else {
                            let formattedCurrency = parseFloat(this.services[0].user_rate || this.services[0].price);
                            this.pricePer = formattedCurrency.toFixed(2);
                        }
                        ...
                        this.avgTime = this.formatAverageTime(this.services[0].average_time_minutes);
                    ...
                    axios.get(url, {
                        ...
                        .then(response => {
                            ...
                            if (this.selectedServiceFromOrder) {
                                ...
                                if (this.currency) {
                                    let formattedCurrency = parseFloat(this.selectedServiceFromOrder.user_rate || this.selectedServiceFromOrder.price) * parseFloat(this.currency.conversion_rate);
                                    this.pricePer = formattedCurrency;
                                } else {
                                    let formattedCurrency = parseFloat(this.selectedServiceFromOrder.user_rate || this.selectedServiceFromOrder.price);
                                    this.pricePer = formattedCurrency;
                                }
                                ...
                                this.avgTime = this.formatAverageTime(this.selectedServiceFromOrder.average_time_minutes);
                            } else {
                ...
                dripFeedChecked() {
                    ...
                    this.dripFeedCheck = isChecked ? 'd-block' : 'd-none'
                },
