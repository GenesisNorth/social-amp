...
@section('content')
    <main id="main" class="main bg-color2 all-orders">
        <div class="pagetitle">
            <h3 class="mb-1">@lang("All Order")</h3>
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">@lang("All")</li>
                </ol>
            </nav>
        </div>
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center border-0">
                <h4>@lang("All Order")</h4>
                <div class="btn-area">
                    <button type="button" class="cmn-btn filter-btn" data-bs-toggle="offcanvas" data-bs-target="#offcanvasExample"
            ...
            <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td data-label="@lang("Price")">
                                            @if(auth()->user()->currency)
                                                <span>
                                                    {{ currencyPositionBySelectedCurrency($order->price * ($currency ? $currency->conversion_rate : 1), auth()->user()->currency) }}
                                                </span>
                                            @else
                                                <span>
                                        ...
                                        <td data-label="@lang("status")">
                                            ...
                                            @elseif($order->status == 'progress')
                                                <span>
                                                    <span class="badge text-bg-primary">@lang("In Progress")</span>
                                                </span>
                                        ...
                                        <td data-label="@lang("Action")">
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li><a class="dropdown-item orderDetailsBtn"
                ...
                @else
                    <div class="text-center p-4">
                        ...
                        <p class="mb-0">@lang("The orders is not available.")</p>
                    </div>
                @endif
