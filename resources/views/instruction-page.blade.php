                ...
                @if(auth()->guard('admin')->check() === false)
                    <div class="col-sm-6">
                        <div class="error-thum">
                            <img class="w-100" src="{{ asset('assets/admin/img/content-error.jpg')}}" alt="...">
                        </div>
                    </div>
                @endif
                <div class="col-sm-6">
                        ...
                        @else
                            <div class="btn-area">
                                <a href="{{ route('switch.language') }}"
                                   class="cmn-btn">@lang('Back To Default Language')</a>
                            </div>
                        @endif
                    </div>
                </div>
                ...
                @if(auth()->guard('admin')->check())
                    <div class="col-sm-12">
                        <div class="instruction-thumbs">
                            <img class="w-100" src="{{ asset('assets/admin/img/content-add-instruction.png')}}" alt="...">
                        </div>
                    </div>
                @endif
            </div>
