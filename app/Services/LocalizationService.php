...
{
    public function createLang($defaultShortName, $shortName, $type = null)
    {
        $defaultPaths = [
            resource_path("lang/"),
    ...
    public function createLangChildPanel($defaultShortName, $shortName, $type = null)
    {
        $defaultPaths = [
            resource_path("lang/"),
            resource_path("lang/default/"),
        ...
        foreach ($defaultPaths as $path) {
            ...
            if ($defaultShortName && file_exists($path . "{$defaultShortName}.json")) {
                $data = file_get_contents($path . "{$defaultShortName}.json");
            } else {
                $data = '{}';
            }
